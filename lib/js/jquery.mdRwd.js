    ...
    $.fn.mdRwd = function(options) {
	    ...
	    function _mdRwdDestroy(){
            ...
            function _mdRwdButtonConnect(){
                ...
                $(document).off("click touchend", mdRwdButtonId);
                $(document).on("click touchend", mdRwdButtonId, function(){
                    opts.mdRwdOnInit();
                    _mdRwdWindowShow();
		...
		if($("#mdRwdWindow").is(":hidden")){
                    ...
                    $("#mdRwdOverlay").fadeIn("fast").promise().done(function() {
                        ...
                        $(document).off("click touchend", "#mdRwdWindowClose, #mdRwdOverlay");
                        $(document).on("click touchend", "#mdRwdWindowClose, #mdRwdOverlay", function(){
                           _mdRwdDestroy();
                       });
                   });
               }
		...
		var deviceLayoutsIds = [];
                ...
                if(deviceLayoutsIds.length > 1){
                    ...
                    $(document).off("click touchend", ".mdRwdLayout");
                    $(document).on("click touchend", ".mdRwdLayout", function(){
		...
		_mdRwdInitCustomCallbacks();
            ...
            function _mdRwdDestroyWindowListeners() {
                ...
                $(document).off("click touchend", "#mdRwdConnectVcButton");
                $(document).off("click touchend", "#mdRwdVcBox .mdRwdWarningBackButton");
                $(document).off("click touchend", "#mdRwdConnectVcBox .mdRwdWarningBackButton");
	    }
		...
		layout.mdRwdOnWsMessage(wsMessage);
            ...
            function _mdRwdConnTypeConnVc(){
                ...
                if($.inArray("connVc", layout.connectionTypesArray) > -1){
                    ...
                    $(document).off("click touchend", "#mdRwdConnectVcButton");
                    $(document).on("click touchend", "#mdRwdConnectVcButton", function(){
		...
		if(wsMessage.statusCode!=mdRwdStatusCodeOk){
                    ...
                    $(document).off("click touchend", "#mdRwdVcBox .mdRwdWarningBackButton");
                    $(document).on("click touchend", "#mdRwdVcBox .mdRwdWarningBackButton", function(){
                        $("#mdRwdVcId").hide();
                        $("#mdRwdVcBox .mdRwdLoadingBox").show();
                        var mdRwdWindowContentHtml = '';
                        mdRwdWindowContentHtml += _mdRwdConnTypeNewVc();
		...
		if(wsMessage.statusCode != mdRwdStatusCodeOk){
                    if(wsMessage.lock){
                        ...
                        if(timeConnVcFail - timeFirtsConnVcFail > opts.connVcTimeout){
                            ...
                            $(document).off("click touchend", "#mdRwdConnectVcBox .mdRwdWarningBackButton");
                            $(document).on("click touchend", "#mdRwdConnectVcBox .mdRwdWarningBackButton", function(){
                                var mdRwdWindowContentHtml = '';
                                mdRwdWindowContentHtml += _mdRwdConnTypeConnVc();
